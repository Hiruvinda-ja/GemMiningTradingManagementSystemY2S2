...
export const money = <i class="fa-solid fa-user-tie"></i>
export const freelance = <i class="fa-solid fa-landmark"></i>
export const stocks = <i class="fa-solid fa-cash-register"></i>
...
export const Investor = <i class="fa-solid fa-user-tie"></i>
export const Land = <i class="fa-solid fa-landmark"></i>
export const Machine = <i class="fa-solid fa-cash-register"></i>