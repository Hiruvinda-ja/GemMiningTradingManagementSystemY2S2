...
exports.addExpense = async (req, res) => {
    ...
    try {
        ...
        // Save the expense if all validations pass
        await expense.save();
...
exports.updateExpense = async (req, res) => {
    ...
    try {
        ...
        // Update the expense if all validations pass
        ...
        res.status(200).json({ success: true, message: 'Expense Updated', updatedExpense });
    } catch (error) {
        res.status(500).json({ success: false, message: 'Server Error', error: error.message });
    }
};
